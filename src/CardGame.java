...
public class CardGame
{
		...
		File cardList)
	{
		...
		piles = new ArrayList<Cardpile>();				//Create the list of piles, will give amount that fits a specific card game
		
		//Create Card Piles
		piles.add(new Cardpile("Draw"));
		piles.add(new Cardpile("Discard"));
	...
	public boolean isValidPlacement(String cardName, int pile, int position) {
		Cardpile newPile = piles.get(pile).clone();
